...
#define JOYCON_Y A6
#define JOYCON_X A9
#define SHOULDER_L A12
#define SHOULDER_R A15
...
{
  x_circle = joyconX / x_max;
  y_circle = joyconY / y_max;
  circle_feeter = atan2(x_circle, y_circle);
  radius = max(x_circle, y_circle);
}
...
void circle_to_triangle()
{
  ...
  x_output = x_0 / max(x_0, y_0) * radius * 255;
  y_output = y_0 / max(x_0, y_0) * radius * 255;
}
